	...
	private void addDropHandling(Pane pane) {
		...
		pane.setOnDragDropped(e -> {
			...
			if (db.hasContent(buttonFormat)) {
				// retorna a linha e coluna da posicao do pane atual ( para a posicao zero È retornado null)
				...
				// retorna a linha e coluna da posicao nova do pane ( para a posicao zero È retornado null)
